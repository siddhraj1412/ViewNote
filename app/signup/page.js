        ...
        <main className="min-h-[80vh] flex items-center justify-center p-4 bg-background">
            <div className="w-full max-w-md">
                <div className="bg-secondary p-8 rounded-3xl border border-white/5 shadow-2xl">
                    <h1 className="text-4xl font-black mb-2 text-center text-accent">JOIN VIEWNOTE</h1>
                    <p className="text-textSecondary text-center mb-8">Start your cinematic journey today.</p>
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-secondary px-2 text-textSecondary uppercase tracking-widest font-bold">Or sign up with</span>
                        </div>
                    </div>
