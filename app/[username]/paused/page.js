    ...
    switch (sortBy) {
        case "oldest":
            return copy.sort((a, b) => {
                const aT = new Date(a.pausedAt || a.addedAt || 0).getTime();
                const bT = new Date(b.pausedAt || b.addedAt || 0).getTime();
                return aT - bT;
            });
        case "a-z":
            ...
            <div className="site-container py-10">
                <div className="flex items-center justify-between gap-4 mb-8">
                    <div className="min-w-0">
                        <h1 className="text-3xl md:text-4xl font-bold truncate">Paused</h1>
