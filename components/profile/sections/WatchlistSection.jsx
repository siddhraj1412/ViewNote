...
export default function WatchlistSection() {
    ...
    useEffect(() => {
        const fetchWatchlistCounts = async () => {
            if (!user?.uid) {
                setLoading(false);
                return;
            }
            ...
            try {
                ...
                console.error("Error fetching watchlist counts:", error);
                setCounts({
                    all: 0,
                    movies: 0,
                    series: 0,
        ...
        <div className="space-y-6">
            ...
            <div className="text-center py-12">
                <p className="text-textSecondary">
                    Watchlist {filter === "all" ? "items" : filter === "short" ? "short films" : filter} will appear here
                </p>
            </div>
        </div>
    );
